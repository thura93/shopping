<?php 
    ...
    if(isset($_GET['product'])){
        $name = mysqli_escape_string($conn, $_GET['product']);
        $result = mysqli_query($conn, "SELECT * FROM products WHERE name = '$name' LIMIT 1");
...
<div class="container">
    ...
    <div class="row mb-5 mt-5">
        ...
        <div class="col-sm-8 col-md-8 mb-5">
            <h3 class="mb-3"><strong>Product Detail View</strong></h3>
            ...
            <div class="row">
                            ...
                            ?>
                                <div class="col-sm-4 mb-3">
                                    <div class="card bg-dark">
                                        <div class="card-body">
                                            <a href="product-detail.php?product=<?= $product['id']; ?>" title="View Detail"><img src="online-admin/public/images/product/<?= $product['image_1']; ?>" class="rounded" width="100%" alt=""></a>
                                            ...
                                            <a href="product-detail.php?add_to_cart=<?= $product['id'] ?>" class="btn btn-sm btn-info float-end"><i class="fa fa-cart-plus"></i> <strong>Add Cart</strong></a>
                                        </div>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                ...
                <?php else : ?>
                    <div class="col-sm-6 col-md-6">
                        <img id="product-detailImg" src="online-admin/public/images/product/<?php echo $product_detail['image_1']; ?>" alt="<?php echo $product_detail['name']; ?>">

                        <div id="slide-wrapper">
                            <span id="slideLeft"><i class="fa fa-chevron-circle-left" aria-hidden="true"></i></span>
                            <div id="slider">
                                <img class="thumbnail active" src="online-admin/public/images/product/<?php echo $product_detail['image_1']; ?>" alt="<?php echo $product_detail['name']; ?>">
                                <img class="thumbnail " src="online-admin/public/images/product/<?php echo $product_detail['image_2']; ?>" alt="<?php echo $product_detail['name']; ?>">
                                <img class="thumbnail " src="online-admin/public/images/product/<?php echo $product_detail['image_3']; ?>" alt="<?php echo $product_detail['name']; ?>">
                            </div>
                            <span id="slideRight"><i class="fa fa-chevron-circle-right" aria-hidden="true"></i></span>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-6">
                        <h5 class="text-info mt-3"> <?php echo $product_detail['name']; ?> </h5>
                        <p><?php echo $product_detail['description']; ?></p> 
                        <h6 class="h5 text-info ms-3">$ <strong class="text-danger"><?php echo $product_detail['price'] ?></strong> USD</h6>
                    </div>       
                <?php endif; ?>
            </div>
