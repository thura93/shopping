    ...
    <div class="row mb-5 mt-5">
        ...
        <div class="col-sm-8 col-md-8 mb-5">
            <?php if(empty($_GET['search'])) : ?>
                <h3 class="mb-3"><strong>Search Product  </strong> '  '</h3>
            <?php else : ?>
                <h3 class="mb-3"><strong>Search Product  </strong> ' <?php echo $_GET['search']; ?> '</h3>
            <?php endif; ?>
            ...
            <div class="row">
                ...
                <?php elseif(isset($_GET['search_btn'])) : ?>
                    <?php 
                        $search = $_GET['search']; 
                        $products = mysqli_query($conn, "SELECT * FROM products WHERE keywords LIKE '%$search%' ");
                    ?>
                        ...
                        <?php if(mysqli_num_rows($products) > 0) : ?>
                            ...
                            <?php endforeach; ?>
                        <?php else : ?>
                            <h3 class="text-danger mt-4"><strong>No Product Not Found.</strong></h3>
                        <?php endif; ?>                  
                <?php else : ?>
                    <?php
